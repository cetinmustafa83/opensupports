export default {
    ...
    'CREATE_TICKET': 'Bildirim Oluştur',
    'TICKET_LIST': 'Bildirim Listesi',
    'SUPPORT_CENTER': 'Destek Merkezi',
    'DEPARTMENT': 'Bölüm',
    'AUTHOR': 'Yazar',
    'DATE': 'Tarih',
    'RESPOND': 'Yanıtla',
    'RESPOND_TICKET': 'Bildirim Yanıtla',
    ...
    'MY_TICKETS': 'Yanıtla',
    'NEW_TICKETS': 'Yeni Bildirim',
    'ALL_TICKETS': 'Tüm Bildirimler',
    'CUSTOM_RESPONSES': 'Hazır Yanıtlar',
    ...
    'VIEW_TICKET': 'Bildirimi Göster',
    'VIEW_TICKET_DESCRIPTION': 'Bildirim numaranızı ve e-postanızı kullanarak bildirimizin durumunu kontrol edin.',
    'SELECT_CUSTOM_RESPONSE': 'Hazır bir yanıt seçin ...',
    'WARNING': 'Uyarı',
    'INFO': 'Bilgi',
    ...
    'ASSIGNED': 'Atanmış',
    'ASSIGNED_TICKETS': '{tickets} bildiri atandı',
    'CLOSED_TICKETS': '{tickets} kapalı bildiriler',
    'LAST_LOGIN': 'Son giriş',
    'ADD_NEW_STAFF': 'Yeni personel ekle',
    'ADD_STAFF': 'Personel ekleme',
    'LEVEL': 'Seviye',
    'LEVEL_1': 'Seviye 1 (Bildiriler)',
    'LEVEL_2': '2. Seviye (Bildiriler + Makaleler)',
    'LEVEL_3': 'Seviye 3 (Bildiriler + Makaleler + Personel)',
    'LEVEL_1_DESCRIPTION': 'Yalnızca bildirileri cevaplayabilir ve kullanıcıları yönetebilir.',
    ...
    'ACTIVITY': 'Aktivite',
    'HOME': 'Ev',
    'TICKET_NUMBER': 'Bildirim Numarası',
    'NEXT': 'Sonraki',
    'SEND_EMAIL_ON_NEW_TICKET': 'Yeni Bildirime e-posta gönder',
    'STAFF_UPDATED': 'Çalışanlar güncellendi',
    'UPDATE': 'Güncelleştirme',
    
    'CHART_CREATE_TICKET': 'Bildiriler Oluşturuldu',
    'CHART_CLOSE': 'Bildiriler Kapandı',
    'CHART_SIGNUP': 'Kayıtlar',
    'CHART_COMMENT': 'Cevaplar',
    'CHART_ASSIGN': 'Atanmış',

    //ACTIVITIES
    'ACTIVITY_COMMENT': 'Yorumlanan Bildiriler',
    'ACTIVITY_ASSIGN': 'Tahsis edilen Bildiriler',
    'ACTIVITY_UN_ASSIGN': 'Atanmamış Bildiriler',
    'ACTIVITY_CLOSE': 'Kapalı Bildiriler',
    'ACTIVITY_CREATE_TICKET': 'Bildiri yarattı',
    'ACTIVITY_RE_OPEN': 'Yeniden açılan Bildiri',
    'ACTIVITY_DEPARTMENT_CHANGED': 'Değiştirilen Bildiriler dairesi',
    'ACTIVITY_PRIORITY_CHANGED': 'Bildirinin önceliği değiştirildi',
    ...
    'ACTIVITY_BAN_USER': 'Yasaklı Kullanıcı',
    ...
    //VIEW DESCRIPTIONS
    'CREATE_TICKET_DESCRIPTION': 'Bu, bir bildiri oluşturmak için kullanılan bir form. Formu doldurun ve bize sorunlarınızı / şüphelerinizi / önerileri gönderin. Destek sistemimiz mümkün olan en kısa zamanda cevaplayacaktır.',
    'TICKET_LIST_DESCRIPTION': 'Burada, destek ekibinize gönderdiğiniz tüm bildirilerin bir listesini bulabilirsiniz.',
    'TICKETS_DESCRIPTION': 'Destek merkezimizden bildiri gönderin ve şüphe, öneri ve sorunlarınızdan yanıt alın.',
    'ARTICLES_DESCRIPTION': 'Sık karşılaşılan sorunlar, kılavuzlar ve belgelerle ilgili makalelerimize bir göz atın.',
    'ACCOUNT_DESCRIPTION': 'Tüm biletler hesabınızın profilinde saklanır. Personel ekibinize gönderdiğiniz tüm bildirilerinizi takip edin.',
    'SUPPORT_CENTER_DESCRIPTION': 'Destek merkezimize hoş geldiniz. Bu bildiri sistemi aracılığıyla bizimle iletişime geçebilirsiniz. Biletleriniz personelimiz tarafından cevaplandırılacaktır.',
    'CUSTOM_RESPONSES_DESCRIPTION': 'Özel yanıtlar, ortak sorunlar için otomatik yanıtlardır',
    'MY_TICKETS_DESCRIPTION': 'Buradan sorumlu olduğunuz bildirileri görüntüleyebilirsiniz.',
    'NEW_TICKETS_DESCRIPTION': 'Burada herkes tarafından atanmamış tüm yeni bildirileri görüntüleyebilirsiniz.',
    'ALL_TICKETS_DESCRIPTION': 'Burada, atanan bölümlerin bildirilerini görebilirsiniz.',
    'TICKET_VIEW_DESCRIPTION': 'Bu bildiri bir müşteri tarafından gönderilmiştir. Buraya cevap verebilir veya bildiri atayabilirsin',
    ...
    'USER_VIEW_DESCRIPTION': 'Burada bir kullanıcı hakkında tüm bilgileri ve kullanıcı tarafından gönderilen tüm bildirileri bulabilirsiniz. Ayrıca silebilir veya yasaklayabilirsiniz.',
    'DELETE_USER_DESCRIPTION': 'Kullanıcı açıklamaya giriş yapamaz ve tüm bildirileri silinir. Ayrıca, e-posta artık kullanılamaz.',
    ...
    'DEPARTMENTS_DESCRIPTION': 'Bu bölüm, bildirim gidebilecek bir gruptur. Biletleri kategorize etmek için kullanılırlar. Onları diğer çalışanlara atayabilirsiniz.',
    ...
    'STATISTICS_DESCRIPTION': 'Burada, bildiriler ve kayıtlar ile ilgili istatistikleri görebilirsiniz.',
    ...
    'SIGN_UP_VIEW_DESCRIPTION': 'Burada, destek merkezimiz için bir hesap oluşturabilirsiniz. Bildiri göndermek ve belgeleri görmek için gereklidir.',
    'EDIT_PROFILE_VIEW_DESCRIPTION': 'Burada e-postanızı veya şifrenizi değiştirerek kullanıcıyı düzenleyebilirsiniz.',
    'ENABLE_USER_SYSTEM_DESCRIPTION': 'Bir kullanıcı sisteminin kullanımını etkinleştirir / devre dışı bırakır. Devre dışı bırakırsanız, tüm kullanıcılar silinir ancak bildiriler muhafaza edilir. Etkinleştirirseniz, mevcut bildiriler kullanıcıları oluşturulur.',
    ...
    'TICKET_SENT_ERROR': 'Oluşturulmaya çalışılırken bir hata oluştu.',
    ...
    'ERROR_RETRIEVING_TICKETS': 'Bildirileri almaya çalışılırken bir hata oluştu.',
    ...
    'INVALID_EMAIL_OR_TICKET_NUMBER': 'Geçersiz e-posta veya bildiri numarası',
    ...
    'WILL_LOSE_CHANGES': 'Bir Hata Oldu ve Değişiklikleriniz Kaybolacak.',
    'WILL_DELETE_CUSTOM_RESPONSE': 'Hazır Yanıt Silinecek.',
    'WILL_DELETE_DEPARTMENT': 'Bölüm silinecek. Tüm bildiriler, seçilen bölüme transfer olacak.',
    ...
    'WILL_DELETE_STAFF': 'Bu eleman silinecek ve tüm bildiriler görevsiz bırakılacaktır.',
    ...
    'ACTIVITY_COMMENT_THIS': 'bu bildiriyi yorumladı',
    'ACTIVITY_ASSIGN_THIS': 'bu bildiriyi atadı',
    'ACTIVITY_UN_ASSIGN_THIS': 'bu bildiri atanmamış',
    'ACTIVITY_CLOSE_THIS': 'bu bildiri kapatıldı',
    'ACTIVITY_CREATE_TICKET_THIS': 'bu bildiri oluşturuldu',
    'ACTIVITY_RE_OPEN_THIS': 'bu bildiri yeniden açıldı',
    'ACTIVITY_DEPARTMENT_CHANGED_THIS': 'bu bildirinin bölümünü değiştir',
    'ACTIVITY_PRIORITY_CHANGED_THIS': 'bu bildirinin önceliğini değiştirildi',
